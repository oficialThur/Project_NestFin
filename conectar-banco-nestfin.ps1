# 🗄️ Script para Conectar ao Banco NestFin
Write-Host "🗄️ Conectando ao Banco NestFin..." -ForegroundColor Green
Write-Host ""
...
try {
    mysql -h localhost -u root -pamordemae -e "USE NestFin; SHOW TABLES;" 2>$null
    Write-Host "✅ Conexão com banco NestFin OK!" -ForegroundColor Green
} catch {
...
Write-Host ""
Write-Host "✅ Projeto NestFin conectado ao banco NestFin!" -ForegroundColor Green
Write-Host ""
