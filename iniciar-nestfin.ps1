# 🚀 Script para Iniciar o NestFin Corretamente
Write-Host "🚀 Iniciando NestFin..." -ForegroundColor Green
Write-Host ""
...
Write-Host "   👤 Informações pessoais do cliente" -ForegroundColor White
Write-Host "   💰 Situação financeira mensal" -ForegroundColor White
Write-Host "   🎯 Progresso da meta financeira" -ForegroundColor White
Write-Host "   📊 Gráfico de economia mensal" -ForegroundColor White
Write-Host "   🔮 Projeções futuras" -ForegroundColor White
