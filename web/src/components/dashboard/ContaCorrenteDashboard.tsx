...
const ContaCorrenteDashboard = () => (
  <div className="flex flex-col items-center gap-0">
    <div className="w-[960px] bg-[#1a2d1a] border border-[#264526] rounded-xl p-6 flex flex-col gap-8 shadow-md">
      <div>
        <div className="text-white text-base font-semibold">Equilíbrio ao longo do tempo</div>
