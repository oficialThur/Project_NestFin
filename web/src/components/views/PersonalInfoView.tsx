      ...
      <div className="w-full max-w-[960px] grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <FormSection title="Informações Pessoais">
          <div className="space-y-3">
            <input
              className="w-full p-3 rounded bg-[#122112] border border-[#4A5D4A] text-sm text-white placeholder-gray-400"
        ...
        <FormSection title="Definir Meta" className="md:col-span-2">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <input
              className="w-full p-3 rounded bg-[#122112] border border-[#4A5D4A] md:col-span-2 text-sm text-white placeholder-gray-400"
        ...
        <FormSection title="Outras Informações" className="md:col-span-2">
          <textarea
            className="w-full p-3 rounded bg-[#122112] border border-[#4A5D4A] h-32 text-sm text-white placeholder-gray-400"
